...
const PRODUCTS: Product[] = [
  { code: 'SKU00011', name: 'DAAL SEV', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00001', name: 'POTATO STICK (CHATPATA)', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00030', name: 'SPICY MIX NIMKO', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00021', name: 'NIMBOO DAAL', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00023', name: 'NIMKO MIX HOT & SPICY', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00024', name: 'NIMKO MIX LEMON & CHILLI', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00003', name: 'MUNCHY (SALTED)', gm: 10, pcsPerCtn: 48, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00005', name: 'MUNCHY (VEGETABLE EU)', gm: 10, pcsPerCtn: 48, retailPrice: 20, tp: 14.75 },
  { code: 'N/A', name: 'MUNCHY (PLAIN)', gm: 10, pcsPerCtn: 48, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00037', name: 'DAAL SEV Box', gm: 192, pcsPerCtn: 12, retailPrice: 240, tp: 177.05 },
  { code: 'SKU00038', name: 'POTATO STICK Box', gm: 192, pcsPerCtn: 12, retailPrice: 240, tp: 177.05 },
  { code: 'SKU00068', name: 'SPICY MIX NIMKO Box', gm: 192, pcsPerCtn: 12, retailPrice: 240, tp: 177.05 },
  { code: 'SKU00039', name: 'NIMBOO DAAL Box', gm: 192, pcsPerCtn: 12, retailPrice: 240, tp: 177.05 },
  { code: 'SKU00040', name: 'NIMKO MIX HOT & SPICY Box', gm: 192, pcsPerCtn: 12, retailPrice: 240, tp: 177.05 },
  { code: 'SKU00041', name: 'NIMKO MIX LEMON & CHILLI Box', gm: 192, pcsPerCtn: 12, retailPrice: 240, tp: 177.05 },
  { code: 'SKU00020', name: 'NIMBOO DAAL 24g', gm: 24, pcsPerCtn: 48, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00009', name: 'DAAL MOUNG 18g', gm: 18, pcsPerCtn: 72, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00042', name: 'DAAL MOUNG Box', gm: 216, pcsPerCtn: 12, retailPrice: 360, tp: 265.57 },
  { code: 'SKU00050', name: 'NIMKO MIX HOT & SPICY 24g', gm: 24, pcsPerCtn: 48, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00002', name: 'POTATO STICK (S&P)', gm: 24, pcsPerCtn: 48, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00034', name: 'SALTED PEANUT 16g', gm: 16, pcsPerCtn: 84, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00031', name: 'PEANUT UNSALTED 16g', gm: 16, pcsPerCtn: 84, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00051', name: 'NIMKO MIX LEMON & CHILLI 24g', gm: 24, pcsPerCtn: 48, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00007', name: 'SPICY MIX NIMKO 24g', gm: 24, pcsPerCtn: 48, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00012', name: 'DAAL SEV 24g', gm: 24, pcsPerCtn: 48, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00004', name: 'MUNCHY (SALTED) 15g', gm: 15, pcsPerCtn: 36, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00006', name: 'MUNCHY (VEGETABLE EU) 15g', gm: 15, pcsPerCtn: 36, retailPrice: 30, tp: 22.13 },
  { code: 'N/A1', name: 'MUNCHY (PLAIN) 15g', gm: 15, pcsPerCtn: 36, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00025', name: 'NIMKO SALT & PEPPER 40g', gm: 40, pcsPerCtn: 36, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00008', name: 'CHEWRA NIMKO', gm: 30, pcsPerCtn: 36, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00010', name: 'DAAL MOUNG 30g', gm: 30, pcsPerCtn: 48, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00035', name: 'SALTED PEANUT 25g', gm: 25, pcsPerCtn: 48, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00032', name: 'PEANUT UNSALTED 25g', gm: 25, pcsPerCtn: 48, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00014', name: 'KHAT MITHA', gm: 30, pcsPerCtn: 36, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00013', name: 'KARACHI NIMCO MIX', gm: 40, pcsPerCtn: 36, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00056', name: 'MUNCHY (SALTED) 25g', gm: 25, pcsPerCtn: 24, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00069', name: 'MUNCHY (VEGETABLE EU) 25g', gm: 25, pcsPerCtn: 24, retailPrice: 50, tp: 36.89 },
  { code: 'N/A2', name: 'MUNCHY (PLAIN) 25g', gm: 25, pcsPerCtn: 24, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00036', name: 'SALTED PEANUT 40g', gm: 40, pcsPerCtn: 36, retailPrice: 80, tp: 59.02 },
  { code: 'SKU00033', name: 'PEANUT UNSALTED 40g', gm: 40, pcsPerCtn: 36, retailPrice: 80, tp: 59.02 },
  { code: 'SKU00029', name: 'SHAHI MIX 80g', gm: 80, pcsPerCtn: 36, retailPrice: 250, tp: 184.43 },
  { code: 'SKU00016', name: 'LAHORI MIX 80g', gm: 80, pcsPerCtn: 36, retailPrice: 180, tp: 132.79 },
  { code: 'SKU00054', name: 'NIMKO SALT & PEPPER 80g', gm: 80, pcsPerCtn: 36, retailPrice: 120, tp: 88.52 },
  { code: 'SKU00028', name: 'SHAHI MIX 180g', gm: 180, pcsPerCtn: 30, retailPrice: 500, tp: 368.85 },
  { code: 'SKU00015', name: 'LAHORI MIX 180g', gm: 180, pcsPerCtn: 30, retailPrice: 400, tp: 295.08 },
  { code: 'SKU00052', name: 'LEMON & CHILLI 180g', gm: 180, pcsPerCtn: 30, retailPrice: 270, tp: 199.18 },
  { code: 'SKU00019', name: 'MASOOR MASALA 180g', gm: 180, pcsPerCtn: 30, retailPrice: 270, tp: 199.18 },
  { code: 'SKU00053', name: 'NIMKO SALT & PEPPER 180g', gm: 180, pcsPerCtn: 30, retailPrice: 270, tp: 199.18 },
  { code: 'SKU00064', name: 'DAAL SEV Strip', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00058', name: 'POTATO STICK Strip', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00059', name: 'SPICY MIX NIMKO Strip', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00060', name: 'NIMBOO DAAL Strip', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00061', name: 'NIMKO MIX HOT & SPICY Strip', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00062', name: 'NIMKO MIX LEMON & CHILLI Strip', gm: 16, pcsPerCtn: 72, retailPrice: 20, tp: 14.75 },
  { code: 'SKU00063', name: 'DAAL MOUNG Strip', gm: 18, pcsPerCtn: 72, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00065', name: 'MASALA PEANUT 16g', gm: 16, pcsPerCtn: 84, retailPrice: 30, tp: 22.13 },
  { code: 'SKU00066', name: 'MASALA PEANUT 25g', gm: 25, pcsPerCtn: 48, retailPrice: 50, tp: 36.89 },
  { code: 'SKU00067', name: 'MASALA PEANUT 40g', gm: 40, pcsPerCtn: 36, retailPrice: 80, tp: 59.02 },
]
